...
namespace Immutable.Search.Model
{
    ...
    public partial class Listing
    {
        ...
        public Listing(string listingId = default(string), MarketPriceDetails priceDetails = default(MarketPriceDetails), string tokenId = default(string), string creator = default(string), string amount = default(string))
        {
