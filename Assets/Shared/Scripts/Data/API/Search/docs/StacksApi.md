# Immutable.Search.Api.StacksApi
...
<a id="searchnfts"></a>
# **SearchNFTs**
> SearchNFTsResult SearchNFTs (string chainName, string? accountAddress = null, List<Guid>? stackId = null, bool? onlyIncludeOwnerListings = null, int? pageSize = null, string? pageCursor = null)
...
namespace Example
{
    public class SearchNFTsExample
    {
        public static void Main()
        {
            ...
            {
                // Experimental: Search NFTs
                SearchNFTsResult result = apiInstance.SearchNFTs(chainName, accountAddress, stackId, onlyIncludeOwnerListings, pageSize, pageCursor);
...
{
    // Experimental: Search NFTs
    ApiResponse<SearchNFTsResult> response = apiInstance.SearchNFTsWithHttpInfo(chainName, accountAddress, stackId, onlyIncludeOwnerListings, pageSize, pageCursor);
